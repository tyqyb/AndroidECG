...
public  class  WaveShowView extends View {
    ...
    private Paint mWavePaint;//心电图的折线
    ...
    private int mWaveMeshesLineColor = Color.parseColor("#C56FAF");//网格颜色
...
//        nowY=0;
//        refreshList.clear();
        Log.d("WaveShowView.Java","Wave Show View Init");
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        System.out.println("In WaveShowView.Java,"+"mHeight: "+mHeight+"  mWidth "+  mWidth+"xSmallNum："+xSmallNum+" ySmallNum:"+ySmallNum+" xBigNum"+xBigNum+" yBigNum："+yBigNum+" row:"+row);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for(int i=0;i< refreshList.size();i++){
         Log.d("WaveShowView.Java",refreshList.get(i)+" ");
        }
        drawGrid(canvas);//绘制网格
        //绘制基线
        ...
        drawWaveLine(canvas);//绘制波形
    }

/**绘制折线**/
    private void drawWaveLine(Canvas canvas) {
        System.out.println("In WaveShowView.Java, starting DrawWaveLine");
        System.out.println();
        System.out.println("RefreshList Size Is:"+refreshList.size());

        if(null == refreshList || refreshList.size()<=0){
            System.out.println("In WaveShowView.Java,Ending DrawWaveLine,Because RefreshList Is Null");
            return;
        }
        ...
        for (int i = 0;i<refreshList.size();i++){
            ...
            System.out.println("In WaveShowView.Java,"+"nowX:"+nowX+", nowY:"+nowY+", dataValue:"+dataValue);
